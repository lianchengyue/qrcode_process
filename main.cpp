...
////////////////////////////////////////////////////////////////////////////////
class ActiveMQAsyncConsumer : public ExceptionListener,
...
ActiveMQAsyncConsumer( const ActiveMQAsyncConsumer& );
ActiveMQAsyncConsumer& operator= ( const ActiveMQAsyncConsumer& );

public:

ActiveMQAsyncConsumer( const std::string& brokerURI,
